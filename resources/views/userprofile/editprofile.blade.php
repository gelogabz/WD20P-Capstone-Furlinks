                    ...
                    <div class="tab-pane fade show active " id="myProfile" role="tabpanel" aria-labelledby="v-pills-myprofile-tab" tabindex="0">
                        ...
                        <div class='row'>
                            ...
                            <div class='col-12 col-md-6 '>
                                ...
                                <input type="text" name="firstname" class="form-control form-control-sm" value="{{$userprofiles->lastname}}" >
                     ...
                     <div class="tab-pane fade show  " id="personalinfo" role="tabpanel" aria-labelledby="v-pills-myprofile-tab" tabindex="0">
                        ...
                        <div class='row mt-2'>
                            <div class='col-12 col-md-6 mt-4'>
                                ...
                                <input type="text" name="hometype" class="form-control" value="{{$userprofiles->hometype}}" >
                            </div>
                    ...
                    <div class="tab-pane fade show  " id="doghistory" role="tabpanel" aria-labelledby="v-pills-myprofile-tab" tabindex="0">    
                        ...
                        <div class="row">
                            ...
                            <div class='col-12 col-md-3 mt-4'>
                                ...
                                <input type="text" name="dogs" class="form-control" value="{{$userprofiles->dogs}}" style="width:80px;" >
                            </div>

                            <div class='col-12 col-md-3 mt-4'>
                                <label for="cats" class=' col-form-label'>If yes, how many cats ?</label>
                                <input type="text" name="cats" class="form-control" value="{{$userprofiles->cats}}" style="width:80px;" >
                            </div>
                       </div>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class='col-12 col-md-6 mt-4'>
                                ...
                                <input type="text" name="priresp" class="form-control" value="{{$userprofiles->priresp}}" >
                            </div>
                        ...
                        <div class="row">
                            <div class='col-12 col-md-6 mt-4'>
                                ...
                                <input type="text" name="finresp" class="form-control" value="{{$userprofiles->finresp}}" >
                            </div>

                            <div class='col-12 col-md-6 mt-4'>
                                <label for='lefthome' class='col-12 col-form-label' >Will your dog be alone at home?</label>
                                <input name='lefthome'class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked >
