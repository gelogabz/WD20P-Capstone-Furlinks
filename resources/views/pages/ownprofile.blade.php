                ...
                <div class="d-flex mt-3">
                    <ul class="nav nav-tabs flex-grow-1 flex-nowrap" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#dogposted" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Dog Posted</a></li>
                        <li>
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#dog-rehomed" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Dog Re-Homed</a></li>
                    </ul>
