    ...
    <div class="row" style="width:100%; margin-top:0px; margin-bottom: 20px;">
      ...
      <div class="col-lg-4 col-sm-6" style="margin-bottom:10px">
        ...
        <div style="text-align: center;">
          ...
          <span style="padding:5px"></span>
          <input class="btn-primary3" id="myBtn4" type="submit" style="float:center;margin-top:10px"><i class="fa-regular fa-pen-to-square" style="font-size:medium;padding-right: 10px"></i>ADOPT
        </div>
      </div>
