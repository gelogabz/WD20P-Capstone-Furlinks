    ...
    <div class="row" style="width:100%; margin-top:0px; margin-bottom: 20px;">
      ...
      <div class="col-lg-4 col-sm-6" style="margin-bottom:10px">
        ...
        <div style="text-align: center;">
          <button class="btn-primary3" id="myBtn4" type="button" style="float:center; margin-top:10px; padding-right:50px; "><i class="fa-regular fa-pen-to-square" style="font-size:medium;padding-right: 15px"></i>Remove Uploaded Image</button>
        </div>
      </div>
