...
<div style="background-color: #F4f4f4;">
    <div class="row align-items-center d-flex mx-0">
        ...
        <div class="col-md-6 my-5">
            <h1 class="display-4 text-center mx-5" style="color:#413F42; font-family:Quicksand; font-weight:800;">ABOUT FURLINKS</h1>
            <br>
            <p class="text-center mx-5" style="font-family: Lato; font-weight:600; color:#413F42;">
               ...
               <br><br>
               In addition to saving a life and providing a loving home, there are many other 
