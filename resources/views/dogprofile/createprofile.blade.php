    ...
    <div class="row" style="width:100%;margin-top:20px">
      ...
      <div class="col-lg-4 col-sm-6" style="margin-bottom:10px">
        <div class="form-group mb-2" style="padding-top:30px;padding-bottom:3px">
          ...
          <div class="image-upload-wrap justify-content-center" style="height:350px;width:350px">
        ...
        <div class="container">
            ...
            <div class="mb-2 row">
              ...
              <div class="col-sm-4">
                  ...
                  <label class="form-label-inline" style="font-size:.8rem; font-style:italic">Year/s</span>
              </div>
              <div class="col-sm-4">
